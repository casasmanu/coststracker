...
def updateExcel(path="C:\DEV\coststracker\GastosMensuales2022.xlsx", sheetName= "GastosVarios",description="TestExpense",cuantity=99,extra=""):
    #receives info, set timestamp, and return dataframe
    x = datetime.datetime.now()
    data=pd.DataFrame({"Date":[x],"Description":description,"Cuantity":int(cuantity),"Extra":extra})
